...
(function () {
    ...
    NanoTools.getHTTPParam = function (paramKey) {
        ...
        if (!NanoTools.HTTPParams) {
            NanoTools.HTTPParams = new Array();
    ...
    NanoTools.getElement = function (id) {
        ...
        dummycontainer.src = '';
        dummycontainer.click = function () { return null };
        dummycontainer.classList = "";
        dummycontainer.show = function () { return null };
        dummycontainer.hide = function () { return null };
    ...
    NanoTools.extend = function (from, to) { for (var i in from) to[i] = from[i]; };
