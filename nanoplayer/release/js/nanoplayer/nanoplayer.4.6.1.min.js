 ...
 */i=[n(77),n(78),n(140),n(164),n(180),n(70),n(25),n(40),n(7),n(4)],void 0===(r=function(e,t,n,i,r,a,o,s,u,d){"use strict";var c=t.events,l=t.states,f=t.emptyConfig,p=t.validConfig,E=t.pauseReasons,h=t.errorCodes,m=t.capabilities,_=n.events,g=n.emptyConfig,T=n.validConfig,S=r.emptyConfig,y=r.validConfig;function b(t){s.validatePlayerDivId(t),this.version=e.NANOPLAYER,console.debug("NanoPlayer api version: "+this.version),this.coreversion="",this.viewversion="",this.type="default",this.id=Math.round(1e11*Math.random()).toString(),this._playerDivId=t,this._core=null,this._view=null,this._metrics=null}var A=b.prototype=Object.create(u.prototype);return A.setup=function(e){var n=d.copy(e);return new Promise(function(e,s){try{var u=c&&c.events&&c.events.onError?c.events.onError:null,d=function(e){e.code||(e.code=h.SETUP.EXCEPTION),e.message||(e.message="An unknown error occured during setup.");var t={name:"Error",data:{code:e.code,message:e.message},player:this._playerDivId,id:this.id,version:this.version,state:l.IDLE};u&&this.on(t.name,u),this.emit(t.name,t),this._initView(this._viewConfig),null!==this._view&&this._view.handleView(b.states.UNINITIALIZED),s(e)}.bind(this),c={};o.extend(n,c),this._bintuConfig=S.create(),this._coreConfig=f.create(),this._viewConfig=g.create(),o.merge(c,this._bintuConfig),o.clean(this._bintuConfig),o.merge(c,this._viewConfig),o.clean(this._viewConfig),this.destroy();var p={};o.extend(n,p),this._checkConfig(p),r.setup(c).then(function(n){try{n.metrics&&(this._metrics=new i,this._metrics.version=this.version,this._metrics.setup(n,this)),o.merge(n,this._viewConfig),o.merge(n,this._coreConfig),this._initView(this._viewConfig),this._core=new t(this._playerDivId),this._core.id=this.id,this._corePropagator=a.create(this._core,b.coreEvents,this),this._setPublicListeners(this._coreConfig.events,this),this._connectLayers(),this._core.setup(this._coreConfig).then(function(t){window.removeEventListener("unload",this.destroy.bind(this)),window.addEventListener("unload",this.destroy.bind(this)),this.coreversion=this._core.version,this.type=this._core.type,this._viewConfig.style&&this._viewConfig.style.view&&this._view.postSetup(),o.extend(this._bintuConfig,t),o.extend(this._viewConfig,t),o.clean(t),e(t)}.bind(this),function(e){null!==this._view&&this._view.handleView(b.states.UNINITIALIZED),s(e)}.bind(this))}catch(e){d(e)}}.bind(this),d)}catch(e){d(e)}}.bind(this))},A.destroy=function(){this._view&&this._view.destroy(),this._view=null,this._core&&this._core.destroy(),this._core=null,this._metrics&&this._metrics.destroy(),this._metrics=null},A._checkConfig=function(e){var t=[];if(e.source&&e.source.bintu){var n=o.check({source:{bintu:e.source.bintu}},y.create());t=t.concat(n)}if(e.style){var i=o.check({style:e.style},T.create());t=t.concat(i)}if(e.source){delete e.source.bintu,delete e.style,delete e.metrics;var r=o.check(e,p.create()).filter((function(e){return-1!==e.indexOf("valid")}));t=t.concat(r)}if(t.length){var a=e&&e.events&&e.events.onWarning?e.events.onWarning:null;a&&this.on(c.WARNING,a),t.forEach(function(e){var t={name:c.WARNING,data:{message:e},player:this._playerDivId,id:this.id,version:this.version,state:l.IDLE};this.emit(t.name,t)}.bind(this))}},A._initView=function(e){!this._view&&this._viewConfig.style&&this._viewConfig.style.view&&(this._view=new n,this._view.version=this.version,this.viewversion=this._view.version,this._view.setBaseValues(this._playerDivId),this._view.baseSetup(e),this._viewPropagator=a.create(this._view,b.viewEvents,this))},A._setPublicListeners=function(e,t){for(var n in e)if(Object.prototype.hasOwnProperty.call(e,n)&&"function"==typeof e[n]){var i=n.replace("on",""),r=e[n];t.on(i,r),delete e[n]}},A._connectLayers=function(){var e=[b.coreEvents.MEDIA];function t(e,t,n,i){for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&-1===t.indexOf(e[r])&&n.on(e[r],i.bind(this))}t(b.coreEvents,e,this,this._onCoreEvent.bind(this)),t(b.viewEvents,[],this,this._onViewEvent.bind(this))},A._onCoreEvent=function(e){if(this._view){if(e.name===b.coreEvents.STATS)return void this._view.handleStats(e.data.stats);e.name===b.coreEvents.STATE_CHANGE&&this._view.update(e),e.name===b.coreEvents.STREAM_INFO&&this._view.handleStreamInfo(e),e.name===b.coreEvents.STREAM_INFO_UPDATE&&this._view.handleStreamInfoUpdate(e),e.name!==b.coreEvents.MUTE&&e.name!==b.coreEvents.UNMUTE||this._view.handleMute(e.name===b.coreEvents.MUTE),e.name===b.coreEvents.VOLUME_CHANGE&&this._view.handleVolume(e.data.volume),e.name===b.coreEvents.READY&&this._view.handleConfig(e.data.config),e.name===b.coreEvents.METADATA&&this._view.handleMetaData(e),e.name===b.coreEvents.UPDATE_SOURCE_SUCCESS&&this._view.handleUpdateSourceSuccess(e),e.name===b.coreEvents.SWITCH_STREAM_SUCCESS&&this._view.handleSwitchStreamSuccess(e)}},A._onViewEvent=function(e){e.name===b.viewEvents.PLAY?this._core.play():e.name===b.viewEvents.PAUSE&&this._core.pause(),e.name===b.viewEvents.MUTE?this._core.mute():e.name===b.viewEvents.UNMUTE&&this._core.unmute(),e.name===b.viewEvents.VOLUME_CHANGE&&this._core.setVolume(e.data.volume)},A._callMethod=function(){if(!this._core)throw new Error('"'+arguments[0]+'" must be implemented or player not initialized by call setup.');return this._core[arguments[0]].apply(this._core,Array.prototype.slice.call(arguments,1))},A.play=function(){this._callMethod("play")},A.pause=function(){this._callMethod("pause")},A.mute=function(){this._callMethod("mute")},A.unmute=function(){this._callMethod("unmute")},A.setVolume=function(e){this._callMethod("setVolume",e)},A.updateSource=function(e,t){return new Promise(function(n,i){r.updateSource(e,t).then(function(e){this._callMethod("updateSource",e.source,t).then((function(e){n(e)}),(function(e){i(e)}))}.bind(this),function(e){var t={name:"Error",data:{code:e.code,message:e.message},player:this._playerDivId,id:this.id,version:this.version,state:l.IDLE};this.emit(t.name,t),i(e)}.bind(this))}.bind(this))},A.switchStream=function(e){return new Promise(function(t,n){this._callMethod("switchStream",e).then((function(e){t(e)}),(function(e){n(e)}))}.bind(this))},A.setAdaption=function(e){this._callMethod("setAdaption",e)},b.states=l,b.coreEvents=c,b.viewEvents=_,b.pauseReasons=E,b.capabilities=m,window.NanoPlayer=b,b}.apply(t,i))||(e.exports=r)},function(e,t,n){var i;void 0===(i=function(){return{NANOPLAYER:"4.6.1"}}.apply(t,[]))||(e.exports=i)},function(e,t,n){var i,r;
/**
 * @license
 * nanoStream H5Live Player Core 4.6.1
 * Build from Thu Aug 06 2020 13:50:59 GMT+0200 (GMT+02:00)
 * Copyright (c) 2020 nanocosmos IT GmbH. All rights reserved.
 * http://www.nanocosmos.de
 * sales@nanocosmos.de
