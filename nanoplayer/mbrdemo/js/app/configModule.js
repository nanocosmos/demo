...
var configModule = (function () {
    var defaultServerUrl = "bintu-play.nanocosmos.de"
    var defaultRtmpUrl = "rtmp://bintu-play.nanocosmos.de/play";
    let entries = [];
    ...
    function buildH5liveObject(index) {
        ...
        validH5liveParams.forEach(function (param, j) {
            ...
            if (_param.includes('server')) {
                ...
                h5live.server = result ? buildServerObject(result) : buildServerObject(defaultServerUrl);
                if (index === 1 && result) {
                ...
                h5live.rtmp.url = result ? result : defaultRtmpUrl;
    ...
    function buildServerObject(serverUrl) {
        ...
        return {
            websocket: defaultServers[protocol].websocket[0] + serverUrl + defaultServers[protocol].websocket[1],
            hls: defaultServers[protocol].hls[0] + serverUrl + defaultServers[protocol].hls[1],
            progressive: defaultServers[protocol].progressive[0] + serverUrl + defaultServers[protocol].progressive[1]
        }
    }

    function buildStreamObject(streamname) {
        // fallbacks
        var serverUrl = defaultServerUrl ? defaultServerUrl : 'bintu-play-devteam.nanocosmos.de';
        var rtmpUrl = defaultRtmpUrl ? defaultRtmpUrl : 'rtmp://bintu-play-prod.nanocosmos.de/play';
        ...
        return {
            ...
            server: buildServerObject(serverUrl)
        }
    }
